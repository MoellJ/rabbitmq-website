...
[Java](/client-libraries/api-guide#recovery), [.NET](/client-libraries/dotnet-api-guide#recovery) and [Bunny](http://rubybunny.info/articles/error_handling.html)
...
See [Java client guide](/client-libraries/api-guide#consuming) for examples.
...
See [Java client guide](/client-libraries/api-guide#getting) for examples.
...
When registering a consumer with an AMQP 0-9-1 client, [the `exclusive` flag](/other-information/amqp-0-9-1-reference#basic.consume)
